  ...
  module.exports = {
    ...
    async execute(interaction ) {
      ...
      var dm = new Discord.MessageEmbed()
        .setColor("#FF0000")
        .setTitle("**Nght Ban System Warning**")
      ...
      var logEmbed = new Discord.MessageEmbed()
        ...
        .addField("**ATTENZIONE:**", `${interaction.user.toString()} *Ha appena bannato dal server: **__${interaction.options.getUser('target').toString()}__**.*`, false)
